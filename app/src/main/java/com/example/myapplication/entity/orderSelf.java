...
public class orderSelf {
    ...
    public orderSelf(int orderId, String userId, String creationTime, double total, State state, String name, String phone, String detail, List<goods> productList, double logisticsFee, String logisticsId)
    {
