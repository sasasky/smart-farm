    ...
    private void initRecyc() {
        ...
        mAdapter.setOnItemClickListener(new User2ListAdapter.OnItemClickListener() {
            ...
            public void onClick(int position) {
                ...
                intent.setClass(PayListActivity.this, PayProductActivity.class);
    ...
    public void requestPay() {
        ...
        call.enqueue(new Callback<orderlist>() {
            ...
            public void onResponse(Call<orderlist> call, Response<orderlist> response) {
                ...
                if(orders==null){
                    Toast.makeText(PayListActivity.this, "没有待支付订单", Toast.LENGTH_SHORT).show();
                }
                for(order item : orders) {
                    if(item.getOrderState()==order.State.unpaid){
                        Order.add(item);
                    }
                }
