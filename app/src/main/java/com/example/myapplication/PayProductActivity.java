...
public class PayProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PayProductActivity.this);//设置弹出框的第二种方法
                builder.setTitle("支付");
    ...
    public void requestPay() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        OrderService request = retrofit.create(OrderService.class);
        Call<Putdata> call = request.payForOrder(orderId);
        call.enqueue(new Callback<Putdata>() {
            ...
            public void onResponse(Call<Putdata> call, Response<Putdata> response) {
                ...
                Toast.makeText(PayProductActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
            }
            @Override
    ...
    public void requestCancel() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        OrderService request = retrofit.create(OrderService.class);
        Call<Putdata> call = request.cancelOrder(orderId);
        call.enqueue(new Callback<Putdata>() {
            @Override
            public void onResponse(Call<Putdata> call, Response<Putdata> response) {
                System.out.println("连接成功");
                System.out.println(response.message()+"   "+response.body());
                Toast.makeText(PayProductActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
            }
            @Override
            public void onFailure(Call<Putdata> call, Throwable throwable) {
                System.out.println("连接失败");
